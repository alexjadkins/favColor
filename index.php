...
$hunna = 100;
echo "Black: " , ($occurences[0] / $numPixels * $hunna) , "<br></br>";
echo "White: " , ($occurences[1] / $numPixels * $hunna) , "<br></br>";
echo "Red: " , ($occurences[2] / $numPixels * $hunna) , "<br></br>";
echo "Green: " , ($occurences[3] / $numPixels * $hunna) , "<br></br>";
echo "Blue: " , ($occurences[4] / $numPixels * $hunna) , "<br></br>";
echo "Yellow: " , ($occurences[5] / $numPixels * $hunna) , "<br></br>";
echo "Cyan: " , ($occurences[6] / $numPixels * $hunna) , "<br></br>";
echo "Orang: " , ($occurences[7] / $numPixels * $hunna) , "<br></br>";
echo "Magenta: " , ($occurences[8] / $numPixels * $hunna) , "<br></br>";
